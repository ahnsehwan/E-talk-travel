...
import 'topresearch_model.dart';
export 'topresearch_model.dart';

class TopresearchWidget extends StatefulWidget {
  const TopresearchWidget({super.key});

  @override
  State<TopresearchWidget> createState() => _TopresearchWidgetState();
}

class _TopresearchWidgetState extends State<TopresearchWidget> {
  late TopresearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopresearchModel());
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      'https://images.unsplash.com/photo-1720268764541-ef64793cab28?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxOYXRpb25hbCUyME11c2V1bSUyMG9mJTIwS29yZWF8ZW58MHx8fHwxNzIyNzc1NTU5fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                      height: 86.0,
                                      fit: BoxFit.cover,
                                    ),
                                  ),
