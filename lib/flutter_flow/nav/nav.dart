...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/eductional',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Eductional')
              : const EductionalWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
        ...
        FFRoute(
          ...
          path: '/directionResult',
          builder: (context, params) => const DirectionResultWidget(),
        ),
        FFRoute(
          name: 'topresearch',
          path: '/topresearch',
          builder: (context, params) => const TopresearchWidget(),
        ),
        FFRoute(
          name: 'bikerental',
          path: '/bikerental',
          builder: (context, params) => const BikerentalWidget(),
        ),
        FFRoute(
          name: 'rentalfare',
          path: '/rentalfare',
          builder: (context, params) => const RentalfareWidget(),
        ),
        FFRoute(
          name: 'payment',
          path: '/payment',
        ...
        FFRoute(
          name: 'rental_hour',
          path: '/rentalHour',
          builder: (context, params) => const RentalHourWidget(),
        )
